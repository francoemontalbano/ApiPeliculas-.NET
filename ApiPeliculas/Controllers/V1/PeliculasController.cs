...
namespace ApiPeliculas.Controllers.V1
{
    ...
    public class PeliculasController : ControllerBase
    {
        ...
        public IActionResult GetPeliculas([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 2)
        {
            ...
            {
                return StatusCode(500, "Error recuperando datos de la aplicación");
            }
        }
        ...
        public IActionResult CrearPelicula([FromForm] CrearPeliculaDto crearPeliculaDto)
        {
            ...
            {
                ModelState.AddModelError("", $"La pelicula {crearPeliculaDto.Nombre} ya existe");
        ...
        public IActionResult Buscar(string nombre)
        {
            ...
            try
            {
                ...
                if (!peliculas.Any())
                {
                    return NotFound($"No se encontraron peliculas que coincidan con los criterios de la pelicula {nombre}.");
                }
